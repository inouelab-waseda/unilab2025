...
namespace unilab2025
{
    ...
    public static Bitmap ByteArrayToBitmap(byte[] byteArray)
        ...
        //    Font fnt_name = new Font("游ゴシック", 30, FontStyle.Bold);
        //    Font fnt_dia = new Font("游ゴシック", 30);
        //    Font fnt_ruby = new Font("游ゴシック", 15); // ルビ用の小さいフォント
        ...
        //    if (isStage)
        //    {
        //        g.DrawImage(Dictionaries.Img_Conversation["MessageWindow"], margin_x, margin_y + 300 + name_y, dia_x, dia_y);
        //    }
        //    else
        //    {
        //        g.DrawImage(Dictionaries.Img_Conversation["MessageWindow"], margin_x, margin_y + 300 + name_y, dia_x, dia_y);
        ...
        //    ////改行の処理はこう書かないとうまくいかない（元コード）
        //    //char[] lineBreak = new char[] { '\\' };
        //    //string[] DialogueLines = Conversations[convIndex].Dialogue.Replace("\\n", "\\").Split(lineBreak);
        //    //for (int i = 0; i < DialogueLines.Length; i++)
        //    //{
        //    //    g.DrawString(DialogueLines[i], fnt_dia, Brushes.White, margin_x + sp_x, margin_y + 300 + name_y + sp_y + i * lineHeight);
        //    //}
        ...
        //    {
        //        // 描画開始位置を計算
        //        // Y座標はルビがはみ出ないように少し下げる
        //        PointF startPoint = new PointF(
        //            margin_x + sp_x,
        //            margin_y + 300 + name_y + sp_y + i * lineHeight + fnt_ruby.Height
        //        );

        //        DrawStringWithRuby(g, DialogueLines[i], fnt_dia, fnt_ruby, Brushes.White, startPoint);
        //    }

        //    // Img列が空欄、またはnullでない場合のみ、キャラクター画像処理を実行する
        //    if (!string.IsNullOrEmpty(Conversations[convIndex].Img))
        //    {
        //        Image charaImage = null;
        //        string imgKey = Conversations[convIndex].Img;

        //        // "Main"と指定されている場合は、選択した主人公の画像を表示
        //        if (imgKey == "Main")
        //        {
        //            if (MainCharacter.isBoy)
        //            {
